...
public class LessonSelectionAdapter extends RecyclerView.Adapter<LessonSelectionAdapter.LessonViewHolder> {
    ...
    public LessonSelectionAdapter(List<LessonCompleted> lessonItems, OnLessonClickListener listener) {
